<?php
// register_employee.php - Admin Only Access
session_start();
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <title>employee Registration - admin Portal</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="registration-form">
            <form id="registerForm" novalidate>
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="emp_name">
                         EMP Name *
                                <span class="tooltip" data-tooltip="Enter the full legal name of the employee">
                            ...
                            <div class="error-text">Please enter a valid employee name (2-100 characters)</div>
                            <div class="success-text">✓ employee name looks good!</div>
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label for="emp_code">
                            company employee code(emp-code) *
                    ...
                    <div class="form-summary" id="formSummary" style="display: none;">
                        ...
                        <div class="summary-content">
                            <div class="summary-item">
                                ...
                                <span class="value" id="summary-emp-name">-</span>
                            </div>
...
<script>
            ...
            switch(field.name) {
                case 'emp_name':
                    if (value.length < 2) {
                        ...
                        isValid = false;
                        errorMessage = 'Employee name is too long';
                    }
                    break;
                ...
                case 'emp_code':
                    const empCodeRegex = /^[A-Za-z0-9]{1,50}$/;
                    if (!empCodeRegex.test(value)) {
                        isValid = false;
                        errorMessage = 'Employee code must be alphanumeric characters only';
                    }
                    break;
            }
        }
    ...
    function updateFormSummary() {
        ...
        const fields = {
            'summary-emp-name': 'emp_name',
            'summary-contact': 'contact_number',
            'summary-email': 'email',
            'summary-crn': 'emp_code'
        };
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('https://customprint.deodap.com/api_dropshipper_tracker/register_employee.php', {
            method: 'POST',
            body: formData
        })
            ...
            if(data.status === 'success') {
                showMessage(
                    ...
                    <div class="success-details">
                        <strong>Employee ID: ${data.emp_id}</strong>
                        <strong>Employee Code: ${data.emp_code}</strong>
                    </div>`, 
                    'success'
                );
                form.reset();
