...
<body>
  ...
  <script>
    ...
    async function initializeFromURL() {
      ...
      if (dropshipperId) chatConfig.dropshipper_id = dropshipperId;
      if (planStepId) chatConfig.plan_step_id = planStepId;
    ...
    async function loadStepAndDropshipperDetails() {
      try {
        ...
        // Disable input and send button if status is pending or completed
        updateInputStateBasedOnStatus();
    ...
    function updateInputStateBasedOnStatus() {
      ...
      if (chatConfig.stepStatus) {
        ...
        if (status === 'pending' || status === 'completed') {
          ...
          messageInput.placeholder = status === 'pending' ? 'Step is pending - messaging disabled' : 'Step completed - messaging disabled';
