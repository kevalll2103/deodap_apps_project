...
class NotPickupByClientCallsScreen extends StatefulWidget {
  final String deviceNumber;
  const NotPickupByClientCallsScreen({required this.deviceNumber, Key? key}) : super(key: key);

  @override
  State<NotPickupByClientCallsScreen> createState() => _NotPickupByClientCallsScreenState();
}

class _NotPickupByClientCallsScreenState extends State<NotPickupByClientCallsScreen> {
  ...
  final String _type = 'not_pickup_by_client';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Not Pickup By Client", style: AppTheme.headingMedium),
        backgroundColor: AppTheme.primaryWarm,
        elevation: 0,
      ),
      body: Column(
