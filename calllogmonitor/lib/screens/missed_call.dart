...
class MissedCallsScreen extends StatefulWidget {
  ...
  const MissedCallsScreen({required this.deviceNumber, Key? key}) : super(key: key);
...
class _MissedCallsScreenState extends State<MissedCallsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Missed Calls", style: AppTheme.headingMedium),
        backgroundColor: AppTheme.primaryWarm,
        elevation: 0,
      ),
      body: Column(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    padding: const EdgeInsets.all(8),
                                    decoration: BoxDecoration(
                                      color: AppTheme.errorWarm.withOpacity(0.12),
                                      shape: BoxShape.circle,
                                      border: Border.all(
                                        color: AppTheme.errorWarm.withOpacity(0.3),
                                        width: 1,
                                      ),
                                    ),
                                    child: Icon(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: AppTheme.errorWarm.withOpacity(0.15),
                                                borderRadius: BorderRadius.circular(8),
                                              ),
                                              child: Text(
                                                'MISSED',
