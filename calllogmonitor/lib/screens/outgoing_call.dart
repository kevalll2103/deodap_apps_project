...
class OutgoingCallsScreen extends StatefulWidget {
  ...
  const OutgoingCallsScreen({required this.deviceNumber, Key? key}) : super(key: key);

  @override
  State<OutgoingCallsScreen> createState() => _OutgoingCallsScreenState();
}
...
class _OutgoingCallsScreenState extends State<OutgoingCallsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Outgoing Calls", style: AppTheme.headingMedium),
        backgroundColor: AppTheme.primaryWarm,
        elevation: 0,
      ),
      body: Column(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    padding: const EdgeInsets.all(8),
                                    decoration: BoxDecoration(
                                      color: AppTheme.infoWarm.withOpacity(0.12),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(
                                              padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                              decoration: BoxDecoration(
                                                color: AppTheme.infoWarm.withOpacity(0.15),
                                                borderRadius: BorderRadius.circular(8),
                                              ),
                                              child: Text(
                                                'OUTGOING',
