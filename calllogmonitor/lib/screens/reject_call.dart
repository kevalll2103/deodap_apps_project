...
class RejectedCallsScreen extends StatefulWidget {
  final String deviceNumber;

  const RejectedCallsScreen({required this.deviceNumber, Key? key}) : super(key: key);

  @override
  State<RejectedCallsScreen> createState() => _RejectedCallsScreenState();
}

class _RejectedCallsScreenState extends State<RejectedCallsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Rejected Calls", style: AppTheme.headingMedium),
        backgroundColor: AppTheme.primaryWarm,
        elevation: 0,
      ),
      body: Column(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    padding: const EdgeInsets.all(8),
                                    decoration: BoxDecoration(
                                      color: AppTheme.warningWarm.withOpacity(0.12),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: AppTheme.warningWarm.withOpacity(0.15),
                                                borderRadius: BorderRadius.circular(8),
                                              ),
                                              child: Text(
                                                'REJECTED',
