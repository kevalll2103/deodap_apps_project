  ...
  void _snack(String msg, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.red.shade700 : const Color(0xFF007E9B),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: const Color(0xFF007E9B), fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: 16),
