...
class cod extends StatefulWidget {
  ...
  @override
  State<cod> createState() => _InviteFriendscreenEmpViewState();
}

class _InviteFriendscreenEmpViewState extends State<cod>
    with TickerProviderStateMixin {

  // iOS Color constants
  static const Color primaryBlue = Color(0xFF007E9B); // iOS blue
