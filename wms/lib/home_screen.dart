...
class _HomeScreenState extends State<HomeScreen>
  ...
  void _goAwaited() => _pushCupertino( AwaitedOrdersScreen());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        padding: const EdgeInsets.fromLTRB(20, 18, 20, 120), // extra bottom for FAB
        children: [
          // Welcome row
          Row(
            children: [
          ...
          // NEW: CLO Awaited Orders (below Club Order Inward)
          _sectionCard(
            child: _iosTap(
              onTap: _goAwaited,
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(CupertinoIcons.clock_solid,
                        color: Color(0xFF00A389), size: 22),
                  ),
                  const SizedBox(width: 12),
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('CLO Awaited Orders',
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.w800)),
                        SizedBox(height: 4),
                        Text(
                          'View/act on orders waiting for CLO action.',
                          style: TextStyle(fontSize: 13, color: Colors.black54),
                        ),
                      ],
                    ),
      ...
      // ===== Center iOS-look Scanner Button (direct to Club Order Inward) =====
      floatingActionButtonLocation: FloatingActionButtonLocation.centerFloat,
      floatingActionButton: _CenterScannerButton(onTap: _goClubOrder),
    );
  }
        ...
        children: [
          ...
          Column(
            children: [
              ...
              ListTile(
                leading:
                const Icon(CupertinoIcons.square_arrow_right, color: Colors.red),
...
// NEW: CLO Awaited Orders screen (stub)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Awaited Orders',
            style: TextStyle(color: Color(0xFF1976D2), fontWeight: FontWeight.w700)),
        iconTheme: const IconThemeData(color: Color(0xFF1976D2)),
        leading: IconButton(
          icon: const Icon(CupertinoIcons.back),
          onPressed: () => Navigator.pop(context),
...
class _CenterScannerButton extends StatelessWidget {
  final VoidCallback onTap;
  const _CenterScannerButton({required this.onTap});

  @override
  Widget build(BuildContext context) {
    // iOS-pill look: translucent, soft shadow, big scanner icon
    return GestureDetector(
      onTap: () {
        HapticFeedback.selectionClick();
        onTap();
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: const [
            Icon(CupertinoIcons.qrcode_viewfinder, size: 22, color: Color(0xFF1976D2)),
            SizedBox(width: 8),
            Text(
              'Open Scanner',
              style: TextStyle(
