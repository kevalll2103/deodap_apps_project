...
import 'package:staff_packing_app/theme/app_color.dart';
import 'package:staff_packing_app/splash/onboardingVo.dart';
  ...
  final List<Map<String, String>> onBoardingData = const [
    {
      ...
      "title": 'Welcome to DeoDap Staff Packaging App',
      "description":
          'Optimize your warehouse operations with DeoDap’s staff packaging app. Track inventory, manage orders, and boost efficiency in app.',
    },
    {
    ...
    },
    {
      ...
      "title": 'Manage Staff Packaging Orders & Tracking',
      "description":
          'Access all staff packaging orders in real time—view pending pickups, mark delays, and monitor packaging activities efficiently.',
    },
  ];
