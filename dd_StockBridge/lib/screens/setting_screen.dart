...
// Theme Colors
const Color kIOSPurple =Color(0xFF007AFF);  
const Color kIOSPurpleLight =  Color(0xFF5AC8FA); 
const Color kIOSPurpleDark = Color(0xFF0051A8); 
...
class _SettingsCupertinoScreenState extends State<setting> {
  ...
  // API Configuration (from admin_profile_screen.dart)
  ...
  // New feature variables - using same structure as admin_profile_screen.dart
              ...
              SliverToBoxAdapter(
                child: _group([
                  ...
                  _cell(
                    ...
                    title: 'Font Size',
                    subtitle: 'Adjust in device settings',
                    trailing: const Icon(CupertinoIcons.chevron_forward, size: 18, color: CupertinoColors.secondaryLabel),
