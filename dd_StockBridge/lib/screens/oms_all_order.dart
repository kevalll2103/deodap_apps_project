...
class OMSApiService {
  static const String listBaseUrl =
      'https://customprint.deodap.com/stockbridge/get_oms_order.php';
...
// MAIN SCREEN
// =====================
class OMSOrdersScreen extends StatefulWidget {
  const OMSOrdersScreen({Key? key}) : super(key: key);

  @override
  State<OMSOrdersScreen> createState() => _OMSOrdersScreenState();
}

class _OMSOrdersScreenState extends State<OMSOrdersScreen>
