    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      if (mounted) {
        if (accountType == 0) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const Login_salespeople()),
          );
        } else {
          Navigator.push(
            context,
          ...
          child: Column(
            ...
            children: [
              ...
              if (isSelected) ...[
                ...
                const SizedBox(height: 44), // Keep consistent height
              ],
            ],
          ),
        ),
            ...
            child: Column(
              children: [
                ...
                _buildAccountTypeCard(
                  title: "Sales Team",
                  subtitle: "Access sales dashboard and\nmanage team operations",
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            "Select 'Sales Team' if you're part of the sales operations.\nSelect 'Dropshipper' if you manage products and orders.",
            style: GoogleFonts.poppins(
              fontSize: 14,
