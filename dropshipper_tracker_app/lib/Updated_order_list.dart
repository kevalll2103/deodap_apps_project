  ...
  Future<void> _fetchOrders() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('https://customprint.deodap.com/api_amzDD_return/only_updated_order.php'),
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredOrders = _orders.where((order) {
          ...
          final sellerName = order['seller_name']?.toString().toLowerCase() ?? '';
                  ...
                  child: Column(
                    children: [
                      _buildOrderDetailRow(
                        Icons.store_rounded,
                        'Seller',
                        '${order['seller_name'] ?? 'N/A'} (${order['seller_id'] ?? 'N/A'})',
                      ),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow('Seller ID', order['seller_id']),
                  _buildDetailRow('Seller Name', order['seller_name']),
                  _buildDetailRow(
                      'Return Tracking ID', order['return_tracking_id']),
                  _buildDetailRow('OTP', order['otp']),
                  _buildDetailRow('Delivery Date',
                      _formatDate(order['out_for_delivery_date'])),
                  _buildDetailRow('Condition', order['bad_good_return']),
                  _buildDetailRow(
                      'Created At', _formatDate(order['created_at'])),
                  _buildDetailRow(
                      'Updated At', _formatDate(order['updated_at'])),
            ...
            // Special Photos Section
            if (order['sticker_photo'] != null ||
                order['unbox_photo'] != null) ...[
              Container(
                margin: const EdgeInsets.symmetric(horizontal: 16),
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (order['sticker_photo'] != null) ...[
                      ...
                      GestureDetector(
                        onTap: () =>
                            _showImageDialog(context, order['sticker_photo']),
                        child: Hero(
                          tag: 'sticker_photo',
                          child: Container(
                            decoration: BoxDecoration(
                    ...
                    if (order['unbox_photo'] != null) ...[
                      ...
                      GestureDetector(
                        onTap: () =>
                            _showImageDialog(context, order['unbox_photo']),
                        child: Hero(
                          tag: 'unbox_photo',
                          child: Container(
                            decoration: BoxDecoration(
                        ...
                        child: Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) =>
                              Container(
                                ...
                                child: Center(
                                  child: Icon(
                                      Icons.broken_image, color: mutedColor,
                                      size: 50),
                                ),
                              ),
                        ),
