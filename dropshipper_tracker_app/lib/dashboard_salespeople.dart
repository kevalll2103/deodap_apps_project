...
import 'dropshipper_plan_sales.dart';
...
class SalespersonDashboard extends StatefulWidget {
  ...
  @override
    State<SalespersonDashboard> createState() => _DashboardState();
}

class _DashboardState extends State<SalespersonDashboard> {
  ...
  Future<void> _checkUserSession() async {
    ...
    if (!isLoggedIn || loginType != 'sales') {
      ...
      print('DEBUG: sales session valid.');
    }
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      userData != null
                          ? userData!['seller_name'] ?? 'sales person'
                          : 'Loading...',
                      style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => PlanScreen_sales()),
                    );
                  },
                ),
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PlanScreen_sales()),
                              );
                            },
