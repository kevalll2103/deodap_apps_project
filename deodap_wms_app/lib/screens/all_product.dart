...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  // ===== Filter Persistence =====
  static const String _filterPrefsKey = 'all_products_filters';
  static const String _searchPrefsKey = 'all_products_search';
  ...
  Future<void> _savePersistedFilters() async {
    try {
      ...
      print('AllProducts: Saved location "$_location" to shared service');
    } catch (e) {
  ...
  Future<void> _restoreTokenAndLoad() async {
    ...
    print('AllProducts: Loaded shared location filter: "$_location"');
                    ...
                    child: Row(
                      children: [
                        ...
                        CupertinoButton(
                          ...
                          onPressed: () {
                            // Apply the temporary filter values before closing
                            setState(() {
