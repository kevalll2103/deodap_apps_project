...
class NotAClaimOrderScreen extends StatefulWidget {
  const NotAClaimOrderScreen({super.key});

  @override
  State<NotAClaimOrderScreen> createState() => _NotAClaimOrderScreenState();
}

class _NotAClaimOrderScreenState extends State<NotAClaimOrderScreen> with TickerProviderStateMixin {
  ...
  Future<void> fetchOrders() async {
    ...
    String url = 'https://customprint.deodap.com/api_amzDD_return/notclaim_order.php';
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Text(
                      "Total Not Claim Orders: ${orders.length}",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
