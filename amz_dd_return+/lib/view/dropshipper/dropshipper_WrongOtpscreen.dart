...
class DropshipperwrongotporderView extends StatefulWidget {
  const DropshipperwrongotporderView({super.key});

  @override
  State<DropshipperwrongotporderView> createState() => _DropshipperCompletedstatusOrderState();
}

class _DropshipperCompletedstatusOrderState extends State<DropshipperwrongotporderView>
  ...
  Future<void> fetchOrders() async {
    ...
    String url = 'https://customprint.deodap.com/api_amzDD_return/seller_get_wrongotp_orders.php?seller_id=$sellerId';
