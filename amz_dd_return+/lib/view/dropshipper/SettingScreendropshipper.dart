...
import 'package:amz/common/app_info_screen_view.dart';
import 'package:amz/common/terms_conditionscreen_view.dart';
import 'package:amz/view/dropshipper/inivite_friend_Screen.dart';
...
class SettingscreenDropshipperView extends StatefulWidget {
  const SettingscreenDropshipperView({super.key});

  @override
  State<SettingscreenDropshipperView> createState() => _SettingscreenDropshipperViewState();
}

class _SettingscreenDropshipperViewState extends State<SettingscreenDropshipperView> {
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            onSelected: (String value) {
              switch (value) {
                case 'help':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => DropshipperHelp()));
                  break;
                case 'about':
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSettingsTile('Invite a friend', '', Icons.group_add, onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => InviteFriendscreenDropshipperView()));
                  }),
