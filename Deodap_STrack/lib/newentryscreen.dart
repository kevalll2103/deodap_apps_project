...
class _NewentryscreenState extends State<Newentryscreen> {
  ...
  Future<void> _submitForm() async {
    ...
    request.fields['action'] = 'inward';
    request.fields['received_from'] = _nameController.text;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(context, true); // Sending data back
        return false;
      },
      child:Scaffold(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: _images.isEmpty
                            ? _buildUploadSection() // Show upload section initially
                            : _buildImageScrollView(), // Show images in horizontal scroll
                      ),
                      const SizedBox(height: 12),

                      // Show "Add More Image" button only if images are less than 4
                      ...
                      // Show "Clear All Images" button if 4 images are added
                      if (_images.length == 4)
                        ElevatedButton.icon(
